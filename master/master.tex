...
\begin{tabitemize}[leftmargin=*]
  ...
  \item Transformed two legacy simulation and analysis codebases—initially underused and fragmented—into robust, modular Python/C++/CUDA frameworks, significantly improving lab-wide productivity and enabling their open-source release to support the broader polymer simulation community.
\end{tabitemize}
