...
2. Edit `Kawak_Academic_CV.tex` and update it with your details.
3. Update the `.bib` files to match your publications/talks/software.
4. Compile with your preferred LaTeX workflow (e.g., `pdflatex` + `bibtex`, or `latexmk`).
